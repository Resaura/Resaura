...
export default function AdvancedScreen() {
  ...
  const handleSendReceipt = () => {
    Alert.alert(
      'Envoi de reéu',
      'L\'envoi automatique de reéus par SMS/WhatsApp sera disponible prochainement',
      [{ text: 'OK' }]
    );
  };
  ...
  return (
    <View {...swipeHandlers} style={[styles.container, { paddingBottom: safeBottom }]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: safeBottom }}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.featureCard} onPress={handleSendReceipt}>
            ...
            <View style={styles.featureContent}>
              <Text style={styles.featureTitle}>Envoyer un reéu</Text>
              <Text style={styles.featureDescription}>
                Envoyez des reéus par SMS ou WhatsApp
              </Text>
            </View>
          </TouchableOpacity>
        </View>
